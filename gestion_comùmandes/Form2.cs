...
namespace WindowsFormsApplication1
{
    public partial class Form2 : Form
    {
        ...
        private void ajouter_Click(object sender, EventArgs e)
        {
            ...
            {
                connexion.cn.Open();
                connexion.cmd.CommandText = "insert into accessoire values('" + t1.Text + "','" + t2.Text + "','" + t3.Text + "','" + t4.Text + "')";
        ...
        private void supprimer_Click(object sender, EventArgs e)
        {
            ...
            {
                connexion.cn.Open();
                connexion.cmd.CommandText = "delete from accessoire where codeacc='"+ t1.Text +"'";
                connexion.cmd.ExecuteNonQuery();
                MessageBox.Show("Bien");
        ...
        private void modifier_Click(object sender, EventArgs e)
        {
            ...
            {
                connexion.cn.Open();
                connexion.cmd.CommandText = "update accessoire set libelle='"+ t2.Text +"',prix='"+ t3.Text +"',stockacc='"+ t4.Text +"' where codeacc='"+ t1.Text +"'";
                connexion.cmd.ExecuteNonQuery();
                MessageBox.Show("Bien");
        ...
        private void rechercher_Click(object sender, EventArgs e)
        {
            ...
            connexion.cmd.CommandText = "select * from accessoire where codeacc='"+ t1.Text +"'";
            ...
            if(connexion.dr.Read()==true)
            {
                ...
                t3.Text = connexion.dr["prix"].ToString();
        ...
        {
            connexion.cn.Open();
            connexion.cmd.CommandText = "select * from accessoire";
            connexion.dr = connexion.cmd.ExecuteReader();
