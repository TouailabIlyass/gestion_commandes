...
namespace WindowsFormsApplication1
{
    public partial class Form6 : Form
    {
        ...
        private void ajouter_Click(object sender, EventArgs e)
        {
            ...
            {
                connexion.cn.Open();
                connexion.cmd.CommandText = "insert into commandes values('" + t1.Text + "','" + t2.Text + "','" + t3.SelectedValue.ToString() + "')";
        ...
        private void modifier_Click(object sender, EventArgs e)
        {
            ...
            {
                connexion.cn.Open();
                connexion.cmd.CommandText = "update commandes set datecom='" + t2.Text + "',codeclt='" + t3.SelectedValue.ToString() + "' where numcom='" + t1.Text + "'";
                connexion.cmd.ExecuteNonQuery();
                MessageBox.Show("Bien");
        ...
        private void supprimer_Click(object sender, EventArgs e)
        {
            ...
            {
                connexion.cn.Open();
                connexion.cmd.CommandText = "delete from commandes where numcom='" + t1.Text + "'";
                connexion.cmd.ExecuteNonQuery();
                MessageBox.Show("Bien");
        ...
        private void rechercher_Click(object sender, EventArgs e)
        {
            ...
            connexion.cmd.CommandText = "select * from commandes where numcom='" + t1.Text + "'";
        ...
        {
            connexion.cn.Open();
            connexion.cmd.CommandText = "select * from commandes";
            connexion.dr = connexion.cmd.ExecuteReader();
        ...
        {
            connexion.cn.Open();
            connexion.cmd.CommandText = "select codeclt,nom+' '+prenom as np  from clients";
            connexion.dr = connexion.cmd.ExecuteReader();

            connexion.bs1.DataSource = connexion.dr;
            t3.DataSource = connexion.bs1;
            
            t3.DisplayMember = "np";
            t3.ValueMember = "codeclt";
        ...
        {
            MessageBox.Show(t3.Text);
        }

        private void button2_Click(object sender, EventArgs e)
        {
            MessageBox.Show(t3.SelectedValue.ToString());
        }
